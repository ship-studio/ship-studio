...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::wordpress::get_wordpress_site_url,
            commands::wordpress::set_wordpress_site_url,
            commands::wordpress::probe_wordpress_site,
            commands::wordpress::derive_wpengine_config,
            commands::wordpress::get_wordpress_ssh,
            commands::wordpress::set_wordpress_ssh,
            commands::wordpress::set_wordpress_pending,
            commands::wordpress::detect_local_wordpress,
            commands::wordpress::reconcile_wordpress_pending,
            // Claude skills
