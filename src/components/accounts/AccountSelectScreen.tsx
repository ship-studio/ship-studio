  ...
  return (
    <div className="account-select-screen">
        ...
        <div className="account-pick-grid" role="list" aria-label="Workspaces">
          ...
          <div className="account-pick-card account-pick-card--new" role="listitem">
            <button
              ...
              disabled={isSwitching}
            >
              <span className="account-pick-card-avatar account-pick-card-avatar--new" aria-hidden>
      ...
      <p className="account-select-footnote text-style-hint">
        Workspaces isolate logins only — not your project files or app settings — and nothing syncs
        to the cloud. <strong>Default</strong> is your existing setup, untouched.
      </p>
